...
const GreenLanternLogo = () => (
  <div className="superheroLogo_container">
    <svg
      ...
      width="500px"
      height="500px"
      viewBox="-229 31 500 500"
      enableBackground="new -229 31 500 500"
    ...
    >
      <path
        ...
        strokeWidth="2"
        strokeMiterlimit="10"
        d="M-88.5,144.5v45.2h54c-35.6,18.7-57.8,55.2-57.8,94.8c0,42.8,25.9,81.6,65.8,98.7h-64.6v41.3h219.3v-41.3
